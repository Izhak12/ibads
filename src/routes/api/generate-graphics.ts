...
4. designBrief: תיאור צילומי בלבד של הרקע — הסובייקט המרכזי, הסביבה, האור, האטמוספירה, פלטת הצבעים, זווית הצילום והקומפוזיציה, וכן היכן נמצא השטח הריק (שליש עליון או שליש תחתון). אין להזכיר טקסט, פונטים, כותרות, באדג'ים או עיצוב כפתור CTA — הטקסט מולבש בשלב אחר. 4-6 שורות בעברית.
  ...
  "items": [
    {
      ...
      "designBrief": "תיאור צילומי בלבד: סובייקט, סביבה, אור, אטמוספירה, פלטת צבעים, זווית וקומפוזיציה, ומיקום השטח הריק — בלי טקסט ובלי אלמנטים גרפיים"
    }
  ]
}`;
}
